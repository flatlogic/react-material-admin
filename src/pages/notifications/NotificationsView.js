      ...
      <Grid item xs={12} md={6} lg={4}>
        <Widget title="Notifications Types" disableWidgetMenu>
          ...
          <div className={classes.buttonsContainer}>
            <Button variant="contained" onClick={() => props.handleNotificationCall('info')} className={classnames(classes.notificationCallButton)}>Info Message</Button>
            <Button variant="contained" onClick={() => props.handleNotificationCall('error')} className={classnames(classes.notificationCallButton)}>Error + Retry Message</Button>
